...
.. note:: In the examples of embARC BSP, PMOD_B is used to connected SPI devices with PMOD interface, e.g. PMOD WiFI, PMOD_C is used to connected UART devices with PMOD interface, e.g. PMOD BLE.
...
.. csv-table:: Pin Description of the Arduino Shield Interface
   :header: Pin,MUX_bitfield,I/O-0,I/O-1,I/O-2,Pin,MUX_bitfield,I/O-0,I/O-1,I/O-2
   :widths: 10,15,20,15,15,10,15,20,15,15
   :align: center

    AD0,Bit 10,ADC IN0/gpio8b_3[7],-,-,IO4,-,gpio8b_2[0],-,-
    AD1,Bit 11,ADC IN1/gpio8b_3[6],-,-,IO5,Bit 3,gpio8b_2[1],-,pwm1    
    AD2,Bit 12,ADC IN2/gpio8b_3[5],-,-,IO6,Bit 4,gpio8b_2[2],-,pwm2
    AD3,Bit 13,ADC IN3/gpio8b_3[4],-,-,IO7,-,gpio8b_2[3],-,-
    AD4,Bit 8/14,ADC IN4/gpio8b_3[3],i2c2_sda,-,IO8,-,gpio8b_2[4],-,-
    AD5,Bit 8/15,ADC IN5/gpio8b_3[2],i2c2_scl,-,IO9,Bit 5,gpio8b_2[5],-,pwm3
    IO0,Bit 0,gpio4b_2[0],uart2_rxd,-,IO10,Bit 1/6,gpio8b_2[6],spi2_cs_n,pwm4
    IO1,Bit 0,gpio4b_2[1],uart2_txd,-,IO11,Bit 1/7,gpio8b_2[7],spi2_mosi,pwm5
    IO2,-,gpio4b_2[2],-,-,IO12,Bit 1,gpio8b_3[0],spi2_miso,gpio8b_3[0]
    IO3,Bit 2,gpio4b_2[3],-,pwm0,O13,Bit 1,gpio8b_3[1],spi2_clk ,gpio8b_3[1]
...
(e.g., u-boot or embarc bootloader) to do this.
