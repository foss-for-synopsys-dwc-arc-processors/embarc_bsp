...
###############################################################################
## ALL ##
CSRCS_DIR		= $(CPU_CSRCDIR) $(DEVHAL_CSRCDIR) $(BOARD_CSRCDIR) $(LIB_CSRCDIR) $(OS_CSRCDIR) $(EXTRA_CSRCDIR) $(APPL_CSRC_DIR)
CXXSRCS_DIR		= $(CPU_CXXSRCDIR) $(DEVHAL_CXXSRCDIR) $(BOARD_CXXSRCDIR) $(LIB_CXXSRCDIR) $(OS_CXXSRCDIR) $(EXTRA_CXXSRCDIR) $(APPL_CXXSRC_DIR)
ASMSRCS_DIR		= $(CPU_ASMSRCDIR) $(DEVHAL_ASMSRCDIR) $(BOARD_ASMSRCDIR) $(LIB_ASMSRCDIR) $(OS_ASMSRCDIR) $(EXTRA_ASMSRCDIR) $(APPL_ASMSRC_DIR)
INCS_DIR		= $(CPU_INCDIR) $(DEVHAL_INCDIR) $(BOARD_INCDIR) $(LIB_INCDIR) $(OS_INCDIR) $(EXTRA_INCDIR) $(APPL_INC_DIR)
###############################################################################
...
##
ALL_CSRCS = $(sort $(CPU_CSRCS) $(BOARD_CSRCS) $(LIB_CSRCS) $(OS_CSRCS) $(APPL_CSRCS) $(EXTRA_CSRCS))
ALL_ASMSRCS = $(sort $(CPU_ASMSRCS) $(BOARD_ASMSRCS) $(LIB_ASMSRCS) $(OS_ASMSRCS) $(APPL_ASMSRCS) $(EXTRA_ASMSRCS))
ALL_CXXSRCS = $(sort $(CPU_CXXSRCS) $(BOARD_CXXSRCS) $(LIB_CXXSRCS) $(OS_CXXSRCS) $(APPL_CXXSRCS) $(EXTRA_CXXSRCS))
ALL_ALLSRCS = $(sort $(ALL_CSRCS) $(ALL_ASMSRCS) $(ALL_CXXSRCS))

##
# Collect all object files
##
ALL_COBJS = $(sort $(CPU_COBJS) $(BOARD_COBJS) $(LIB_COBJS) $(OS_COBJS) $(APPL_COBJS) $(EXTRA_COBJS))
ALL_ASMOBJS = $(sort $(CPU_ASMOBJS) $(BOARD_ASMOBJS) $(LIB_ASMOBJS) $(OS_ASMOBJS) $(APPL_ASMOBJS) $(EXTRA_ASMOBJS))
ALL_CXXOBJS = $(sort $(CPU_CXXOBJS) $(BOARD_CXXOBJS) $(LIB_CXXOBJS) $(OS_CXXOBJS) $(APPL_CXXOBJS) $(EXTRA_CXXOBJS))
